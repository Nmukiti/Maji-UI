        ...
        findViewById(R.id.ALM_btnPayment).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (layout.getVisibility() != View.VISIBLE && layoutMpesa.getVisibility() != View.VISIBLE) {
                    ...
                    Intent stklaunchIntent=getApplicationContext().getPackageManager().getLaunchIntentForPackage("com.android.stk");
                    if (stklaunchIntent !=null){
                        startActivity(stklaunchIntent);
                    }
